  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-purple-100 flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8 flex flex-col items-center gap-6">
        <h1 className="text-3xl font-bold text-indigo-800">Login to Your Account</h1>
        
        {showReset ? (
          <div className="w-full">
            <h2 className="text-xl font-semibold text-indigo-700 mb-4">Reset Password</h2>
            {resetMessage && (
            ...
            <form onSubmit={handlePasswordReset} className="flex flex-col gap-4">
              ...
              <div className="flex gap-3">
                <button
                  type="submit"
                  disabled={loading}
                  className="flex-1 py-3 rounded-xl bg-indigo-600 text-white font-semibold hover:bg-indigo-700 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 shadow-md disabled:opacity-50"
                >
                ...
                <button
                  ...
                  className="flex-1 py-3 rounded-xl bg-gray-200 text-gray-700 font-semibold hover:bg-gray-300 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 shadow-md"
                >
                  Cancel
                </button>
              </div>
